...
QT_MOC_LITERAL(1, 12, 3), // "yes"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 2), // "no"
QT_MOC_LITERAL(4, 20, 20), // "on_yesButton_clicked"
QT_MOC_LITERAL(5, 41, 19), // "on_noButton_clicked"
QT_MOC_LITERAL(6, 61, 23) // "on_cancelButton_clicked"

    },
    "CloseDialog\0yes\0\0no\0on_yesButton_clicked\0"
    "on_noButton_clicked\0on_cancelButton_clicked"
};
...
void CloseDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CloseDialog *_t = static_cast<CloseDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->yes(); break;
        case 1: _t->no(); break;
        ...
        {
            typedef void (CloseDialog::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CloseDialog::yes)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (CloseDialog::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CloseDialog::no)) {
                *result = 1;
                return;
            }
        }
